    ...
    <div className="flex flex-col gap-6 sm:gap-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            La proyección usa lo que ahorraste en los últimos tres meses.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                      ...
                      <>
                        ...
                        {entry.monthlyPace > 0 ? (
                          <span className="flex items-center gap-1">
                            ...
                            {formatCurrency(entry.monthlyPace, entry.goal.currency)} por
                            mes
                          </span>
                        ) : (
                        ...
                        {entry.goal.target_date && (
                          <span
                            className={cn(
                              entry.isOnTrack === false && "text-destructive",
                            )}
                          >
